...
RUN wget http://192.168.0.120:8081/nexus/content/repositories/gameoflife/gameoflife-goup/gameoflife.war/3.0/gameoflife.war-3.war -O /usr/local/tomcat/webapps/gameoflife.war
EXPOSE 8080
